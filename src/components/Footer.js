...
// import TempaFlorida from '../allstar/src/components/locations/TempaFlorida';
  ...
  return (
   <div className="footerMain w-[100vw] h-[110vh] flex justify-center items-end z-[20]">
      <div className="footer flex flex-col justify-center items-center w-[100vw] h-[95vh]">
        ...
        <hr className='mb-[10%] md:!mb-20 w-[95%] flex justify-center 0' />
        <div className="linksToWork w-[100%] h-[50%] p-3">
          <div className="linkTopBox w-[100%] h-[55%] flex flex-row flex-wrap md:flex-nowrap justify-around">
            ...
            <div className="locations w-[15%] h-[55%] flex flex-col ml-80 pr-1 md:mr-85  items-end md:items-start relative overflow-visible ">
